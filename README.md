...
4. Відкрийте ваш веб-браузер і перейдіть за адресою [http://localhost:8080/authentication](http://localhost:8080/authentication)
...
**НЕ МОЖЕ:**
  ...
  - помічати задачу виконаною статус якої **Видаленно**
